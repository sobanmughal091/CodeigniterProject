            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Patient Bill</h4>
                                <form method="POST" name="addpatientbillform" id="addpatientbillform"
                                    action="<?= base_url('create-bill')  ?>">
                                    <div class="form-group">
                                        <label for="patient_name">Patient Name</label>
                                        <input type="text" class="form-control" name="patient_name" id="patient_name"
                                            value="<?= set_value('patient_name') ?>" placeholder="Patient Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="net_total" id="net_total"
                                            value="<?= set_value('net_total') ?>" placeholder="Net total">
                                        <?= form_error('net_total') ?>
                                    </div>
                                    <button type="submit" name="submit" class="btn btn-primary me-2">Submit</button>
                                    <a href="<?= base_url('bill-list-page') ?>" class="btn btn-dark">Back</a>
                                </form>
                            </div>
                        </div>
                    </div>
