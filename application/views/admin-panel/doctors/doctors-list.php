                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <a href="<?= base_url('add-doctor') ?>" class="btn btn-inverse-primary btn-fw mt-4 mb-3 ms-5">Add
                                        Doctor</a>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <form method="get" action="<?= base_url('doctors-list') ?>">
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-auto">
                                                <a href="<?= base_url('doctors-list') ?>" class="btn btn-inverse-info btn-fw" style="padding: 9px;">Reset</a>
                                            </div>
                                        </div>
                                    </form>
